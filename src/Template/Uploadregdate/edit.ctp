<div class="actions columns large-2 medium-3">
    ...
    <ul class="side-nav">
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $uploadregdate->Registration_ID],
                ['confirm' => __('Are you sure you want to delete # {0}?', $uploadregdate->Registration_ID)]
            )
        ?></li>
...
<div class="uploadregdate form large-10 medium-9 columns">
    ...
    <fieldset>
        <legend><?= __('Edit Uploadregdate') ?></legend>
        <?php
