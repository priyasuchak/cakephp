<div class="actions columns large-2 medium-3">
    ...
    <ul class="side-nav">
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $individualWorkInfoT->Individual_Work_Info_ID],
                ['confirm' => __('Are you sure you want to delete # {0}?', $individualWorkInfoT->Individual_Work_Info_ID)]
            )
        ?></li>
...
<div class="individualWorkInfoT form large-10 medium-9 columns">
    ...
    <fieldset>
        <legend><?= __('Edit Individual Work Info T') ?></legend>
        <?php
