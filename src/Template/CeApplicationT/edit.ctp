<div class="actions columns large-2 medium-3">
    ...
    <ul class="side-nav">
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $ceApplicationT->Ce_Application_ID],
                ['confirm' => __('Are you sure you want to delete # {0}?', $ceApplicationT->Ce_Application_ID)]
            )
        ?></li>
...
<div class="ceApplicationT form large-10 medium-9 columns">
    ...
    <fieldset>
        <legend><?= __('Edit Ce Application T') ?></legend>
        <?php
