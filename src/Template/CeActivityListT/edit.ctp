<div class="actions columns large-2 medium-3">
    ...
    <ul class="side-nav">
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $ceActivityListT->Ce_Activity_ID],
                ['confirm' => __('Are you sure you want to delete # {0}?', $ceActivityListT->Ce_Activity_ID)]
            )
        ?></li>
...
<div class="ceActivityListT form large-10 medium-9 columns">
    ...
    <fieldset>
        <legend><?= __('Edit Ce Activity List T') ?></legend>
        <?php
