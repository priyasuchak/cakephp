<div class="actions columns large-2 medium-3">
    ...
    <ul class="side-nav">
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $testindividual->Individual_ID],
                ['confirm' => __('Are you sure you want to delete # {0}?', $testindividual->Individual_ID)]
            )
        ?></li>
...
<div class="testindividual form large-10 medium-9 columns">
    ...
    <fieldset>
        <legend><?= __('Edit Testindividual') ?></legend>
        <?php
