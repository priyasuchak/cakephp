...
<fieldset>
<legend><?= __('<b><font size="3", color="#93191B">Exam Deferment Options:</font><font size="2", color="#93191B"> Please choose from the following exams</font></b>') ?></legend>
<legend><?= __('<font size="2", color="#8E7A4A">Your current exam information:</font>') ?></legend></br>
<legend><?= __('<font size="2", color="#8E7A4A">Exam Date: '.h($recentExamInfo->Exam_Date).'</font>') ?></legend>
<legend><?= __('<font size="2", color="#8E7A4A">Exam Location: '.h($recentExamInfo->examRegistrationInfo[0]->Location).'</font>') ?></legend>
<legend><?= __('<font size="2", color="#8E7A4A">Deferment Deadline: '.h($recentExamInfo->Deferment_Deadline).'</font>') ?></legend>
<legend><?= __('<font size="2", color="#8E7A4A">Deferrals Remaining: '.h($deferralsremaining).'</font>') ?></legend>
<legend><?= __('<font size="2", color="red">*Candidates are permitted to defer an exam registration twice. Additional deferrals will incur a full exam registration fee.</font>') ?></legend>
