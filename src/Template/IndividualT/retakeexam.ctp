...
<legend><?= __('<font size="2", color="#8E7A4A">Your previous exam information:</font>') ?></legend>
...
<legend><?= __('<font size="2", color="#8E7A4A">Outcome: </font><font size="2" color="red">'.h($recentExamInfo->examRegistrationInfo[0]->Outcome).'</font>') ?></legend>
