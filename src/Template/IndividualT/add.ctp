<div class="actions columns large-2 medium-3">
    <h3><?= __('Actions') ?></h3>
    <ul class="side-nav">
        <li><?= $this->Html->link(__('List Individual T'), ['action' => 'index']) ?></li>
    </ul>
</div>
<div class="individualT form large-10 medium-9 columns">
    <?= $this->Form->create($individualT); ?>
    <fieldset>
        <legend><?= __('Add Individual T') ?></legend>
        <?php
