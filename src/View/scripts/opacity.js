...
// This is the original file that has been compressed into opacity.js by http://javascriptcompressor.com/
...
function od_object_setBackground() {	
	...
	this.layerObject.backgroundRepeat = "no-repeat";
}
//---------------------------------------------------------------
...
function od_displayImage(strId, strPath, intWidth, intHeight, strClass, strAlt, sdisplay) {	
	if (pngAlpha) {
		document.write('<div style="height:'+intHeight+'px;width:'+intWidth+'px;filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src=\''+strPath+'.png\', sizingMethod=\'scale\')" id="'+strId+'" class="'+strClass+'" display="'+sdisplay+'"></div>');
	} else if (pngNormal) {
		document.write('<img src="../directory_files/'+strPath+'.png" width="'+intWidth+'" height="'+intHeight+'" name="'+strId+'" border="0" class="'+strClass+'" alt="'+strAlt+'" display="'+sdisplay+'" />');
	} else {
		document.write('<img src="../directory_files/'+strPath+'.gif" width="'+intWidth+'" height="'+intHeight+'" name="'+strId+'" border="0" class="'+strClass+'" alt="'+strAlt+'" display="'+sdisplay+'" />');
	}
}
//---------------------------------------------------------------
...
// Outputs the image as a div with the AlphaImageLoader, or with
// a standard image tag.
function od_simple(strId, strPath, intWidth, intHeight) {	
	if (pngAlpha) {
		...
		document.write('<div id="'+strId+'"><img src="../directory_files/'+strPath+'.png" name="'+strId+'" /></div>');
	} else {
		document.write('<div id="'+strId+'"><img src="../directory_files/'+strPath+'.gif" name="'+strId+'" /></div>');
	}
}
//---------------------------------------------------------------
